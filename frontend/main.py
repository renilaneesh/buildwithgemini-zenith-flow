...
_meta = _load_deployment_meta()
RESOURCE = os.environ.get(
    "AGENT_ENGINE_RESOURCE_NAME",
    _meta.get("remote_agent_runtime_id", "projects/940261231717/locations/us-east1/reasoningEngines/3951022466645622784")
)
# The agent's app directory (matches agent_directory in agents-cli-manifest.yaml).
AGENT_DIRECTORY = os.environ.get("AGENT_DIRECTORY", _meta.get("agent_directory", "app"))
